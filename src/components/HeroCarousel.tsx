              ...
              >
                <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-card shadow-hover group-hover:shadow-soft transition-all">
                  <img
                    ...
                    alt={featuredProduct.node.title}
...
export const SaleProducts = () => {
  ...
  if (loading) {
    return (
      <section className="py-10 md:py-16 bg-gradient-to-br from-destructive/5 via-background to-accent/5">
  ...
  return (
    <section className="py-10 md:py-16 bg-gradient-to-br from-destructive/5 via-background to-accent/5 relative overflow-hidden">
      {/* Decorative elements */}
